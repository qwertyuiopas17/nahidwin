...
class OptimizedCrisisDetector:
    ...
    def __init__(self, model_path: str = None, load_semantic_model: bool = True):
        ...
        self.critical_crisis_keywords = [
            ...
            'writing my will', 'saying goodbye', 'can\'t go on anymore','kill myself', 'killing myself', 'wanna kill myself', 'gonna kill myself', 'end my life', 'ending my life', 'want to end my life',
            'commit suicide', 'planning suicide', 'my suicide plan',
            'take my own life', 'taking my own life',
            'ready to jump', 'have the pills', 'have the gun', 'have the rope',
            'final goodbye', 'this is my last message'
        ]
        ...
        self.strong_crisis_keywords = [
            ...
            'permanent solution', 'escape this pain', 'make it stop forever', 'suicidal thoughts', 'thoughts of killing myself', 'thinking about suicide',
            'want to die', 'wanna die', 'wish i was dead',
            'better off dead', 'better if i was dead',
            'ending it all', 'thinking of ending it all',
            'cant go on', 'can\'t go on living',
            'no reason to live', 'life has no meaning',
            'tired of living', 'tired of being alive',
            'ready to give up', 'i give up', 'world better without me'
        ]
